...
python -m run.cv_inference exp_name=exp081_mixup_short_feat14 model.encoder_weights=null model=Spec2DCNNSplit model.n_split=1  datamodule.zero_periodicity=True duration=17280  batch_size=8 "features=014" feature_extractor=LSTMFeatureExtractor downsample_rate=6 num_tta=3 phase=train 

python run/cv_train.py exp_name=exp085_split_drop3  "pos_weight=[1.0, 5.0, 5.0]" batch_size=8 "features=014" model=Spec2DCNNSplit model.n_split=1  epoch=30 monitor=val_score monitor_mode=max duration=17280  datamodule.zero_periodicity=True datamodule.zero_periodicity=True decoder.dropout=0.3 downsample_rate=6 augmentation.mixup_prob=0.3 "augmentation.mixup_alpha=0.5" offset=5 
python -m run.cv_inference exp_name=exp085_split_drop3 model.encoder_weights=null model=Spec2DCNNSplit model.n_split=1  datamodule.zero_periodicity=True duration=17280  batch_size=8 "features=014" downsample_rate=6 num_tta=3 phase=train # 0.8001
